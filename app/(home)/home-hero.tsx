				...
				<div className="container">
					...
					<div className="grid grid-cols-1  lg:grid-cols-3  gap-8 py-4">
						...
						>
							...
							/>
							<article className="w-full h-[150px] rounded-lg shadow-lg p-6 flex flex-col gap-x-4 justify-between items-center bg-white border border-blue-300">
								<Image
						...
						>
							<Image
								...
								className="w-full aspect-[4/2] lg:aspect-[5/2] object-cover rounded-lg"
							/>
							<article className="w-full h-[150px] rounded-lg shadow-lg p-6 gap-x-4 flex flex-col justify-between items-center bg-white border border-brand">
								<Image
							...
							<div className="w-full grid grid-cols-1  gap-4">
								...
								<Card>
									...
									<CardContent>
										<p className="text-sm leading-6 ">
											Flexible & Modular Commercial and Industrial Energy
											Storage Solutions
										</p>
									</CardContent>
								</Card>
						...
						>
							<Image
								...
								className="w-full aspect-[4/2] lg:aspect-[5/2] object-cover rounded-lg"
							/>
							<article className="w-full h-[150px] rounded-lg shadow-lg p-6 gap-x-4 flex flex-col justify-around items-center bg-white border border-yellow-600">
								<Image
							...
							<div className="w-full grid grid-cols-1  gap-4">
								<Card>
									...
									<CardContent>
										<p className="text-sm leading-6 ">
											Discover our top-quality electrical services for
