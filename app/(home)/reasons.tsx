...
const cards = [
  {
    title: "Solar Power Installations powered by SIGENERGY",
    description:
  ...
  {
    title: "Solar Water Pumps with Lorentz Technology",
    description:
...
const Reasons = () => {
  return (
    <section className="py-5">
      <div className="container rounded-lg shadow-lg bg-fuchsia-950 p-8 text-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {cards.map((card, index) => (
            ...
            >
              ...
              <p className="text-sm mt-2 text-fuchsia-200 leading-6">{card.description}</p>
            </div>
          ))}
        </div>
      </div>
